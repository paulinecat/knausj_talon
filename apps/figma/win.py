...
class UserActions:
    ...
    # def figma_frame_selection(): actions.key('')
    # def figma_toggle_hide_selection(): actions.key('')
    # def figma_toggle_lock_selection(): actions.key('')
    # def figma_duplicate(): actions.key('')
    # def figma_rename_selection(): actions.key('')