...
class UserActions:
    ...
    def figma_deep_select(): actions.key('')
    def figma_select_layer_menu(): actions.key('')
    def figma_select_children(): actions.key('')
    def figma_select_parent(): actions.key('')
    def figma_select_next_sibling(): actions.key('')
    def figma_select_prev_sibling(): actions.key('')
    def figma_group_selection(): actions.key('')
    def figma_ungroup_selection(): actions.key('')
